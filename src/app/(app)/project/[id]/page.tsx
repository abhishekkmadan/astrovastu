...
export default async function ProjectDetailPage({
  ...
  const latestLayout = safeLayouts[0];
      ...
      <div className="mt-4 flex items-start justify-between">
        ...
        {latestLayout ? (
          ...
          <button
            type="button"
            disabled
            className="flex items-center gap-2 rounded-lg bg-surface-dim px-4 py-2 text-sm font-medium text-text-muted cursor-not-allowed"
            title="Upload a layout before generating a PDF"
          >
            <FileText size={16} />
            Generate PDF
          </button>
