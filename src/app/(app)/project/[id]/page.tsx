      ...
      <div className="mt-4 flex items-start justify-between">
        ...
        {latestLayout ? (
          ...
          <button
            type="button"
            disabled
            title="Upload a floor plan before generating a PDF"
            className="flex items-center gap-2 rounded-lg bg-surface-dim px-4 py-2 text-sm font-medium text-text-muted opacity-70"
          >
            <FileText size={16} />
            Generate PDF
          </button>
