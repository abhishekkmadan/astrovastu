...
This creates tables (profiles, projects, layouts, layout_markers), RLS policies, a signup trigger, the layout workspace-phase column, and a private storage bucket for floor plans.
